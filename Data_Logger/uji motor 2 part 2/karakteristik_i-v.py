...
def plot_all_gmpp():
    ...
    gmpp_files = [os.path.join(base_dir, f'gmpp{suffix}.txt') for suffix in ['', '1', '2', '3', '4', '5']]
    ...
    for run_idx, nama_file in enumerate(gmpp_files):
        try:
            ...
            out_name = os.path.join(base_dir, f'karakteristik_i-v_run{run_idx}.png')
            out_name_pdf = os.path.join(base_dir, f'karakteristik_i-v_run{run_idx}.pdf')
